...
export class ProductService {
  constructor() {}
  getDetailedProduct(): Observable<DetailedProduct> {
    //mock backend
    ...
    return of(detailedProduct).pipe(delay(2000));

    // }
    // // get product images
    // getImages(): Promise<string[]> {
    //   return Promise.resolve(this.detailedProduct.image_urls);
    // }

    // getDescription(): Promise<ProductDescription> {
    //   return Promise.resolve(this.detailedProduct.description);
    // }

    // // Get Providers
    // getProviderData(): ProviderInfo[] {
    //   return this.detailedProduct.providers;
    // }

    // // get product tabs
    // getProductTabs(): ProductTabs[] {
    //   return this.detailedProduct.tabs;
    // }

    // // get related Product
    // getRelatedProducts(): RelatedProduct[] {
    //   return this.detailedProduct.related_products;
    // }
  }
}
